...
public class MerchantManager : MonoBehaviour
{
    ...
    {
        if(_costCounterInt > 0)
            _endMoney.text = "Are you sure you want to spend " + Math.Abs(_costCounterInt) + " For Buying this groceries?";
        else if(_costCounterInt < 0)
            _endMoney.text = "Are you sure you want to get " + Math.Abs(_costCounterInt) + " For Selling this groceries?";
        else if(_costCounterInt == 0)
